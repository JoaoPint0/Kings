 ...
 */
class EventsAdapter : PagedListAdapter<Battle, RecyclerView.ViewHolder>(EVENT_COMPARATOR) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (eventItem != null) {
            (holder as EventsViewHolder).bind(eventItem)
        }
    }

    companion object {
        private val EVENT_COMPARATOR = object : DiffUtil.ItemCallback<Battle>() {
